...
// function after connected and initial image shows 
afterConnection = () => {
    console.log("***********************************")
    console.log("*                                 *")
...
addRole = () => {
    inquirer.prompt([
        ...
        .then(answer => {
            ...
            // use department table to grab department 
...
updateManager = () => {
    // use employee table to get employees 
  const employeeSql = `SELECT * FROM employee`;
